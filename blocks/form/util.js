...
export const validityKeyMsgMap = {
  ...
  rangeOverflow: { message: 'maximum', attribute: 'max' },
  rangeUnderflow: { message: 'minimum', attribute: 'min' },
  tooLong: { message: 'maxLength', attribute: 'maxlength' },
  tooShort: { message: 'minLength', attribute: 'minlength' },
